...
import sys
import os
from PySide6.QtWidgets import QApplication, QMainWindow, QFileSystemModel, QMessageBox, QListWidgetItem
...
class PkjvizMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.ui.fileExplorerTreeView.setRootIndex(self.file_model.index(QDir.homePath()))
    ...
    def environment_changed(self, index):
        """环境变更事件"""
    ...
    def refresh_devices(self):
        ...
        for i in range(count):
            device_name = self.device_model.data(self.device_model.index(i, 0), Qt.DisplayRole)
            device_data = self.device_model.data(self.device_model.index(i, 0), Qt.UserRole)

...
class DiagnosticResult(QObject):
    ...
    @table_desc.setter
    def table_desc(self, value: str) -> None:
        """设置表描述"""
    ...
    def add_field(self, name: str, description: str, value: str) -> None:
        """添加字段"""
        self._fields.append({"name": name, "description": description, "value": value})
        self.result_changed.emit()

    def update_field(self, index: int, name: str, description: str, value: str) -> None:
        """更新字段"""
